<%-- 
    ...
    Created on : Apr 2, 2018, 9:44:36 PM
    Author     : viquy
--%>

<%@page import="com.aptechlibrary.utilities.STATUS_TYPE"%>
<%@page import="java.util.ArrayList"%>
<%@page import="com.aptechlibrary.beans.LoanBookListBean"%>
<%@page import="com.aptechlibrary.controllers.BookLoanController"%>
<%@page import="com.aptechlibrary.utilities.Constants"%>
...
<html>
    ...
    <body>
        ...
        %>
        <c:if test="${hasStatus eq false}"/>
        <c:choose>
            <c:when test="${request.getAttribute(Constants.HAS_STATUS) != null}"/>
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html"> Aptech Library Management System</a>
                </div>
